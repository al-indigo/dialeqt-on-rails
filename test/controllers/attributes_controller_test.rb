...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { author: @attribute.author, description: @attribute.description, identifier: @attribute.identifier, name: @attribute.name }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { author: @attribute.author, description: @attribute.description, identifier: @attribute.identifier, name: @attribute.name }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
